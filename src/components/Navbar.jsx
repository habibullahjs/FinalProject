                ...
                <div className="items-center flex ">
                    <div className="w-full lg:w-1/4 relative">
                        <div className="flex items-center gap-2" ref={cateRef}>
                            ...
                            <h3 className="font-dms text-[14px] text-[#262626] font-normal hidden lg:block">
                                Shop by Category
                            </h3>
                        </div>
                        {cateShow && (
                            <div className="bg-[#262626] py-3 absolute left-0 right-0 top-[40px] z-10  lg:w-sm w-xs">
                                <ul>
                    ...
                    <div className="w-full lg:w-2/4">
                        <div className="relative">
                            <input
                                type="text"
                                lg:placeholder="Search Products" placeholder="search.."
                                className="lg:w-full bg-white py-3 pl-4"
                            />
                    ...
                    <div className="w-full lg:w-1/4 relative">
                        ...
                        {accShow && (
                            <div className="w-[200px] absolute lg:left-[30%] left-[-186%] top-[41px] z-10">
                                <ul>
                        ...
                        {cartshow && (
                            <div className="absolute lg:left-0 left-[-300%] right-0 top-[40px] w-xs bg-[#F5F5F3] z-10">
